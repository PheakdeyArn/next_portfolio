            ...
            <div className="flex justify-center relative my-20 z-10">
                <div className="max-w-[80vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                    {/* <h2 className="uppercase tracking-widest text-xs text-center text-blue-100 max-w-80">
                        Hi! My name is Arn Sovannpheakdey Arn 
                    </h2> */}

                    <TextGenerateEffect
                        className="text-center text-[40px] md:text-5xl lg:text-6xl"
                        words="Hi! My name is Sovannpheakdey Arn"
                    />

                    <h2 className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-1xl">
                        Full-Stack developer base in Phnom Penh, Cambodia.
                    </h2>
                    <a href="#about">
                        <MagicButton
                            title="Show my work"
